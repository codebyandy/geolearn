...
def train(args, saveFolder):
    ...
    xS, xL, xM, xcT, yT, mask = randomSubset(data, trainInd, testInd, satellites, 'train', batch_size)
    ...
    for ep in range(epochs):
        ...
        xS, xL, xM, xcT, yT, mask = randomSubset(data, trainInd, testInd, satellites, 'test', batch_size)
        ...
        if ep > 0 and ep % test_epoch == 0:
            ...
            split_indicies = {"test_quality": testInd, "test_poor": testIndBelow}
