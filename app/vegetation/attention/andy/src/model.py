...
class AttentionLayer(nn.Module):
    ...
    def forward(self, x):
        ...
        d = q.shape[1]
        score = torch.bmm(q.transpose(1, 2), k) / np.sqrt(d)
...
class FinalModel(nn.Module):
    def __init__(self, nTup, nxc, nh, out_method):
        super().__init__()
        self.nTup = nTup
        self.nxc = nxc
        ...
        self.out_method = out_method # experimentations by andy
