...
python helpers/submitJob.py --wandb_name stratify-check --note modisgrid-new-const --split_version stratified --dataset singleDaily-modisgrid-new-const --cross_val True